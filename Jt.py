...
â–’â–‘â–’   â–‘ â–‘ â–‘ â–’  â–‘ â–’   â–’â–’ â–‘  â–‘  â–’   â–‘ â–‘ â–’  â–‘
 â–‘    â–‘   â–‘ â–‘    â–‘   â–’   â–‘          â–‘ â–‘   
 â–‘          â–‘  â–‘     â–‘  â–‘â–‘ â–‘          â–‘  â–‘
      â–‘                  â–‘                Made By {H2}Ban{M2}glad{H2}eshi {O2}Programmer""",style=f"{color_table}"))
def bersihkan_layar():
...
{} [{} Pilih No {}1{}/{}2 {}]
{}        â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–º {}'''.format(B,P,H,self.nama,P,H,self.sim,B,K,P,K,P,M,P,K,P,K,M,P,H))
...
========================================
 [ Pilih No 1/2 ]
        â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–º {}'''.format(P,H))
...
{}========================================
{} [ {}input nama {}]
{}        â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â–º {}'''.format(B,P,P,H,B,M,P,M,P,H))
		...
		bersihkan_layar()
		banner()
		self.notice = ('''{}â”œâ”€â”€> While Waiting for Results
{} Results OK Saved In :FX_OK.txt
{} Results CP Saved In :FX_CP.txt
